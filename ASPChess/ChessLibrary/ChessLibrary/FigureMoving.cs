namespace ChessLibrary
{
    class FigureMoving : IComparable<FigureMoving>
    {
        ...
        private string ParseRandomMove(string move)
        {
            var commandSegments = move.Split(' ', StringSplitOptions.RemoveEmptyEntries);

            Figure f = (Figure)Enum.Parse(typeof(Figure), commandSegments[0]);


            return $"{f.ToChar()}{commandSegments[1]}{commandSegments[2]}";
        }
